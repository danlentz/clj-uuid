(ns clj-uuid.bitmop2
  "ByteBuffer-based bitwise operation primitives for UUID manipulation.

  Provides the same mask/ldb/dpb fundamentals as bitmop.clj, plus a
...
;; NOTE: this module carries forward the same unchecked primitive-math
;; approach as bitmop.clj.  All long-level operations (mask, ldb, dpb)
;; should be considered internal implementation details and used with
;; appropriate external checks in place.
...
;; Bit-masking
;;
;; Encapsulates the complexity of working with unsigned 64-bit values
;; on the JVM.  The mask/ldb/dpb abstraction is carried forward from
;; bitmop.clj unchanged, as it remains fundamental to UUID field
;; extraction and construction regardless of the buffer representation.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;
;; These replace the manual shift/mask loops in bitmop.clj with single
;; ByteBuffer operations.  A putLong/getLong is one native call vs. an
;; 8-iteration loop with dpb/ldb per byte.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
